<%@ Page Title="" Language="C#" MasterPageFile="~/Base.Master" AutoEventWireup="true" CodeBehind="frmExpenseRequestHOD.aspx.cs" Inherits="Armstrong_ARER_V2.Webforms.frmExpenseRequestHOD" %>
    ...
    <div class="page-header page" style="margin-left: -3%;">
        <div class="row" style="margin-right: -4%;">
            ...
            <div class="col-sm-7 text-left" style="padding-right: 0px;">
                <h1 class="page-title">&nbsp;Expense Report for Approval </h1>
            </div>
                                    ...
                                    <div class="row" style="margin-top:-20px;">
                                        <div class="col-xl-12">
                                            <div class="example table-responsive">
                                                ...
                                                <tbody>
                                                    <tr class="gradeA odd">
                                                        ...
                                                        <td>A646</td>
                                                        <td>Mumbai</td>
                                                        <td style="text-align: right;"> <input class="form-control input-sm" style="border-color:white;text-align:left;" name="txtAutoAmount" value="Auto Fair" type="text" /></td>
                                                        <td style="text-align: right;"> <input class="form-control input-sm" style="border-color:white;text-align:right;" name="txtAutoAmount" value="&#8377 6500" type="text" /></td>
                                                        <td>456</td>
                                                        <td>
                                                    ...
                                                    <tr class="gradeA even">
                                                        ...
                                                        <td>A639</td>
                                                        <td>Mumbai</td>
                                                        <td style="text-align: right;"> <input class="form-control input-sm" style="border-color:white;text-align:left;" name="txtAutoAmount" value="Phone Expenses" type="text" /></td>
                                                        <td style="text-align: right;"> <input class="form-control input-sm" style="border-color:white;text-align:right;" name="txtAutoAmount" value="&#8377 1500" type="text" /></td>
                                                        <td>98</td>
                                                        <td>
                                                            <input class="form-control input-sm" style="border-color:white;text-align:left;" name="txtAutoAmount" placeholder="Enter Remarks(if any)" type="text" />
                                                        </td>
                                                    ...
                                                    <tr class="gradeA odd">
                                                        ...
                                                        <td>A687</td>
                                                        <td>Dubai</td>
                                                        <td style="text-align: right;"> <input class="form-control input-sm" style="border-color:white;text-align:left;" name="txtAutoAmount" value="Travel by Plane" type="text" /></td>
                                                     <td style="text-align: right;"> <input class="form-control input-sm" style="border-color:white;text-align:right;" name="txtAutoAmount" value="&#8377 8000" type="text" /></td>
                                                        <td>456</td>
                                                        <td>
                                                            <input class="form-control input-sm" style="border-color:white;text-align:left;" name="txtAutoAmount" placeholder="Enter Remarks(if any)" type="text" />
                                                        </td>
                                                    ...
                                                    <tr class="gradeA even">
                                                        ...
                                                        <td>A687</td>
                                                        <td>Pune</td>
                                                        <td style="text-align: right;"> <input class="form-control input-sm" style="border-color:white;text-align:left;" name="txtAutoAmount" value="Other Expenses" type="text" /></td>
                                                        <td style="text-align: right;"> <input class="form-control input-sm" style="border-color:white;text-align:right;" name="txtAutoAmount" value="&#8377 9600" type="text" /></td>
                                                        <td>456</td>
                                                        <td>
                                                            <input class="form-control input-sm" style="border-color:white;text-align:left;" name="txtAutoAmount" placeholder="Enter Remarks(if any)" type="text" />
                                                        </td>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4" style="text-align: right;"><h4>&#8377 50000</h4></div>
